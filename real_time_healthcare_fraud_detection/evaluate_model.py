...
# === CONFIG ===
DATA_PATH = "dataset/phantom_billing_test.csv"
MODEL_PATH = "models/phantom_billing/fraud_detector.pkl"
SCALER_PATH = "models/phantom_billing/scaler.pkl"
ENCODER_PATH = "models/phantom_billing/label_encoder.pkl"
LABEL_COL = "Fraud Type"

print("\n🔍 Evaluating model on phantom_billing_test.csv")
...
try:
    ...
    # === PREPROCESS ===
    X, y = preprocess_data(df, is_training=True, label_column=LABEL_COL)
    ...
    plt.title("Confusion Matrix - Phantom Billing")
    plt.show()
    ...
    try:
        if len(df_original) != len(predicted_labels):
            ...
            df_original.to_csv("phantom_billing_predictions.csv", index=False)
            print("\n✅ Saved: phantom_billing_predictions.csv")
